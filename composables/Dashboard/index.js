export const CardList = () => {
    return [
        ...
        },
        {
            title: "Comments",
            digit1: "152",
            digit1Postfix: "Unread",
            digit2: "85",
            message: "newly     responded",
...
export const SalesRecord = () => {
    return [
        {
            productName: "Space T-Shirt",
            productType: "Clothing",
            consumerName: " Anuj Rawat",
            amount: 242.00,
            transcationType: "Credit Card"
        },
        {
            productName: "Portal Sticker",
            productType: "Accessories",
            consumerName: " john wide",
            amount: 130.00,
            transcationType: "Debit Card"
        },
        {
            productName: "Supernova Sticker",
            productType: "Accessories",
            consumerName: " Nikhil Kumar",
            amount: 249.00,
            transcationType: "Credit Card"
        },
        {
            productName: "Wonders Notebook",
            productType: "Office",
            consumerName: " Pheclukwayo",
            amount: 42.00,
            transcationType: "COD"
        },
        {
            productName: "Mat Black Case",
            productType: "Accessories",
            consumerName: " jodqulepio",
            amount: 534.00,
            transcationType: "Credit Card"
        },
        {
            productName: "Robots T-Shirt",
            productType: "Clothing",
            consumerName: "kelly crosnetle",
            amount: 124.00,
            transcationType: "Credit Card"
        }
...
export const NotificationRecords = () => {
    return [
        {
            icon: 'pi-dollar bg-cyan-200 text-cyan-800',
            comment: "Richard Jones has purchased a blue t-shirt for 79$"
        },
        {
            icon: 'pi-download bg-indigo-200 text-indigo-800',
            comment: "Your request for withdrawal of 2500$ has been initiated."
        },
        {
            icon: 'pi-dollar bg-cyan-200 text-cyan-800',
            comment: "Keyser Wick has purchased a black jacket for 59$"
        },
        {
            icon: 'pi-question bg-red-300 text-red-800',
            comment: "Jane Davis has posted a new questions about your product."
        }
    ]
}